...
- Lười biếng (Lazy Evaluation): thực hiện các phương thức trên dữ liệu cách lười biếng, chỉ thực sự ghi lại kết quả khi cần thiết --> giúp tiết kiệm tài nguyên, cải thiện hiệu suất
